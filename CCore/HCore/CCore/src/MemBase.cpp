...
MemStat::MemStat() noexcept { Object->getStat(*this); }

/* struct MemPeak */

MemPeak::MemPeak() noexcept { Object->getPeak(*this); }

/* Mem...() functions */

void * TryMemAlloc(ulen len) noexcept { return Object->alloc(len); }

ulen MemLen(const void *mem) noexcept { return Object->getLen(mem); }

bool MemExtend(void *mem,ulen len) noexcept { return Object->extend(mem,len); }

bool MemShrink(void *mem,ulen len) noexcept { return Object->shrink(mem,len); }

void MemFree(void *mem) noexcept { Object->free(mem); }

void MemLim(ulen limit) noexcept { Object->setLim(limit); }
