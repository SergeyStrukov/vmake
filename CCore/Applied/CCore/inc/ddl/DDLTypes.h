...
struct IntType
 {
  ...
  void cast(SUIntType auto value_)
   {
    value=(SUInt)value_;
   }
...
struct imp_sint8 : IntType<imp_sint8,sint8>
 {
  ...
  explicit imp_sint8(SUIntType auto value) { cast(value); }
 };
...
struct imp_uint8 : IntType<imp_uint8,uint8>
 {
  ...
  explicit imp_uint8(SUIntType auto value) { cast(value); }
 };
...
struct imp_sint16 : IntType<imp_sint16,sint16>
 {
  ...
  explicit imp_sint16(SUIntType auto value) { cast(value); }
 };
...
struct imp_uint16 : IntType<imp_uint16,uint16>
 {
  ...
  explicit imp_uint16(SUIntType auto value) { cast(value); }
 };
...
struct imp_sint32 : IntType<imp_sint32,sint32>
 {
  ...
  explicit imp_sint32(SUIntType auto value) { cast(value); }
 };
...
struct imp_uint32 : IntType<imp_uint32,uint32>
 {
  ...
  explicit imp_uint32(SUIntType auto value) { cast(value); }
 };
...
struct imp_sint64 : IntType<imp_sint64,sint64>
 {
  ...
  explicit imp_sint64(SUIntType auto value) { cast(value); }
 };
...
struct imp_uint64 : IntType<imp_uint64,uint64>
 {
  ...
  explicit imp_uint64(SUIntType auto value) { cast(value); }
 };
...
struct imp_sint : IntType<imp_sint,sint_type>
 {
  ...
  explicit imp_sint(SUIntType auto value) { cast(value); }
 };
...
struct imp_uint : IntType<imp_uint,uint_type>
 {
  ...
  explicit imp_uint(SUIntType auto value) { cast(value); }
 };
...
struct imp_ulen : IntType<imp_ulen,ulen_type>
 {
  ...
  explicit imp_ulen(SUIntType auto value) { cast(value); }
 };
...
struct SLen
 {
  ...
  void cast_uint(UIntType auto value,Flag flag_)
   {
  ...
  explicit SLen(SUIntType auto value)
   {
    cast(value);
   }
