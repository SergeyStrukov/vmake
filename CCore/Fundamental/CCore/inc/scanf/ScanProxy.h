...
template <class T>
concept Has_ScanOptType = requires()
 {
...
template <class T>
concept No_ScanOptType = !Has_ScanOptType<T> ;

/* concept Has_ScanProxyType<T> */

template <class T>
concept Has_ScanProxyType = requires()
 {
...
template <class T>
concept No_ScanProxyType = !Has_ScanProxyType<T> ;
