...
class IntToStr : NoCopy
 {
  ...
  public:
   ...
   void print(PrinterType auto &out,ulen width,IntAlign align) const
    {
     auto str=getStr();
   ...
   static void Print(PrinterType auto &out,ulen fract,PtrLen<const char> pref,PtrLen<const char> suff,ulen extra=0)
    {
     out.put(pref.ptr,pref.len);
   ...
   void print(PrinterType auto &out,ulen width,ulen fract,IntAlign align) const
    {
     auto pref=getPrefix();
     auto suff=getSuffix();
     ulen len;
   ...
   class Engine : NoCopy
    {
     ...
     public:
      ...
      void print(PrinterType auto &out,PtrLen<const UInt> data)
       {
        if( +data )
          {
