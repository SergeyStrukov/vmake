...
RadixHeapStore_small::RadixHeapStore_small() noexcept
 {
 }
...
void RadixHeapStore::ins(RadixHeapBlock *block) noexcept
 {
...
void RadixHeapStore::del(RadixHeapBlock *block) noexcept
 {
  ulen ind=Index(block->len);
...
RadixHeapBlock * RadixHeapStore::find_and_del(ulen len) noexcept
 {
  ulen ind=Index(len);
