...
template <class T>
concept SwapMovableType = NothrowDefaultCtorType<T> && Has_objSwap<T> ;
...
template <class T>
concept Has_objMove = requires()
 {
  Ground< T * (T::*)(Place<void>) >( &T::objMove );
 } ;

/* concept No_objMove<T> */

template <class T>
concept No_objMove = !Has_objMove<T> ;
...
template <class T>
concept ReplaceableType = Has_objMove<T> || Has_ToMoveCtor<T> || MoveCtorType<T> || SwapMovableType<T> || CopyCtorType<T> ;
