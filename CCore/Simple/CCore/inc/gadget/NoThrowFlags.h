...
template <class T>
concept TrueDefaultNoThrowType = Meta::IsBaseOf<SetDefaultNoThrowFlag<T,true>,T> ;

template <class T>
concept FalseDefaultNoThrowType = Meta::IsBaseOf<SetDefaultNoThrowFlag<T,false>,T> ;

template <class T>
concept NoDefaultNoThrowType = !( TrueDefaultNoThrowType<T> || FalseDefaultNoThrowType<T> ) ;


template <class T>
concept TrueCopyNoThrowType = Meta::IsBaseOf<SetCopyNoThrowFlag<T,true>,T> ;

template <class T>
concept FalseCopyNoThrowType = Meta::IsBaseOf<SetCopyNoThrowFlag<T,false>,T> ;

template <class T>
concept NoCopyNoThrowType = !( TrueCopyNoThrowType<T> || FalseCopyNoThrowType<T> ) ;
