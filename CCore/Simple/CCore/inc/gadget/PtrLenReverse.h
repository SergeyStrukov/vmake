...
auto RangeReverse(RangeAccessType auto &&obj) { return RangeReverse(obj.getPtr(),obj.getLen()); }

auto RangeReverse_const(const RangeAccessType auto &obj) { return RangeReverse_const(obj.getPtr_const(),obj.getLen()); }
